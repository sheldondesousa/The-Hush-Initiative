  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #7469B6 0%, #AD88C6 25%, #E1AFD1 50%, #F7D6EC 75%, #FFE6E6 100%)'
        }}
      >
        {/* Left Side - Login Credentials (50%) */}
        <div className="w-1/2 flex flex-col justify-center items-center px-12">
          <div className="max-w-md w-full bg-white bg-opacity-75 backdrop-blur-md p-8 rounded-2xl shadow-lg">
            {/* Logo */}
        ...
        <div className="w-1/2 flex flex-col justify-center items-center px-12">
          ...
          <div className="flex justify-center gap-6 mt-8">
            <img src="/Store download button-Apple.svg" alt="Download on App Store" className="h-16" />
            <img src="/Store download button-Google.svg" alt="Get it on Google Play" className="h-16" />
          </div>
        </div>
      </div>
    </>
