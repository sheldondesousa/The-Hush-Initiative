  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white border border-gray-300 rounded-2xl shadow-sm p-8">
        ...
        {/* Social Login Buttons - Google first, then Apple */}
        <div className="space-y-3 mb-8">
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors bg-white">
          ...
          <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors bg-white">
            ...
            <span className="font-medium text-black">Log In with Apple</span>
          </button>
        </div>
